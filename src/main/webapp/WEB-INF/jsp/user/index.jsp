...
<input class="forgetUrl" type="hidden" value="<%=path%>/user/forget"/>
...
<DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
    ...
    <P style="padding: 30px 0px 10px; position: relative;"><SPAN
            class="u_logo"></SPAN> <INPUT onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" class="ipt uName" title="帐号" name="uName" type="text" placeholder="请输入用户名或邮箱" value="">
    </P>
    ...
    <DIV style="height: 50px; line-height: 50px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
        ...
        <A class="forget" style="color: rgb(204, 204, 204);" href="#">忘记密码?</A></SPAN>
        <SPAN style="float: right;">
            	<a class="changeSubmit" style="color: rgb(204, 204, 204); margin-right: 10px;"
                                           href="javascript:">快速注册</a>
