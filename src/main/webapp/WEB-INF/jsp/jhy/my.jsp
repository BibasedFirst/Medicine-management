...
<hr> 
 <div style="width:250px;float: left" >
    <form class="bs-example bs-example-form" role="form" action="<%=path %>/jhy/udpatemy" method="post">
 ...
 <div style="width:250px;float: left;padding-left: 50px;padding-top: 35px" >
    <form class="bs-example bs-example-form" role="form" action="<%=path %>/jhy/udpatemymm" method="post">
         <div class="input-group input-group-sm"  >
